    ...
    <>
      ...
      <header className="fixed top-10 left-1/2 -translate-x-1/2 z-50 w-[96%] max-w-[1200px]">
        <nav className="bg-gray-950/70 backdrop-blur-xl rounded-2xl px-8 md:px-16 py-4 flex justify-between items-center border border-gray-800/50 shadow-2xl shadow-gray-950/50 hover:border-blue-500/30 transition-all duration-300">
          ...
          {/* Desktop Navigation */}
          <div className="hidden md:flex gap-8 items-center" role="navigation" aria-label="Main Navigation">
            <button
        ...
        {/* Mobile Navigation */}
        {isMenuOpen && (
          <div className="md:hidden mt-4 bg-gray-950/80 backdrop-blur-xl border border-gray-700/60 rounded-2xl shadow-2xl shadow-gray-950/50 overflow-hidden" role="menu">
      ...
      {/* Hero */}
      <section id="hero" className="pt-44 pb-24 bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="container relative z-10 flex flex-col items-center justify-center px-4">
          <div className="text-center max-w-4xl">
            ...
            <p className="text-2xl md:text-3xl text-gray-300 mb-6 font-light tracking-wide">
              Full-Stack Developer <span className="text-blue-400" aria-hidden="true">•</span> AI/ML Researcher <span className="text-blue-400" aria-hidden="true">•</span> Problem Solver
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              <img
                ...
                alt="Profile photo of Malavya Raval"
            ...
            {projects.map((project) => (
              ...
              >
                <a
                  ...
                  className="block p-6 min-h-[240px] flex flex-col justify-between relative overflow-hidden"
                >
                  ...
                  <div className="relative z-10">
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-blue-500 to-cyan-400 flex items-center justify-center text-white font-bold text-base shadow-lg group-hover:shadow-blue-500/50 transition-shadow duration-300" aria-hidden="true">
                  ...
                  <footer className="pt-6 border-t border-gray-700/40 flex items-center justify-between gap-4 relative z-10">
                    ...
                    <span className="flex items-center text-blue-400 font-semibold text-sm group-hover:text-cyan-300 transition-all duration-300 whitespace-nowrap">
                      <svg
      ...
      >
        <div className="container mx-auto px-4">
              ...
              {skillCategories.map((category) => (
                ...
                >
                  <div className="relative z-10 flex items-center gap-4 mb-4 ml-2">
                    <span className="text-4xl transform group-hover:scale-125 transition-transform duration-300" aria-hidden="true">{category.icon}</span>
          ...
          {/* Achievements */}
          <section className="mt-32 pt-24 border-t border-gray-700/60 w-full">
            ...
            <div className="flex justify-center w-full px-4 md:px-8">
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 w-full max-w-6xl">
                <article className="group relative bg-gradient-to-br from-blue-500/20 to-blue-600/10 rounded-2xl p-8 min-h-[140px] text-center border border-blue-500/40 hover:border-blue-400/80 hover:shadow-lg hover:shadow-blue-500/30 transition-all duration-300 cursor-default overflow-hidden">
                ...
                <article className="group relative bg-gradient-to-br from-yellow-500/20 to-yellow-600/10 rounded-2xl p-8 min-h-[140px] text-center border border-yellow-500/40 hover:border-yellow-400/80 hover:shadow-lg hover:shadow-yellow-500/30 transition-all duration-300 cursor-default overflow-hidden">
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" aria-hidden="true">
                    <div className="absolute inset-0 bg-gradient-to-br from-yellow-600/20 to-transparent"></div>
                  </div>
                  <div className="relative z-10 flex flex-col items-center justify-center h-full">
                    <div className="text-4xl font-bold text-yellow-300 mb-3 group-hover:text-yellow-200 transition-colors duration-300" aria-hidden="true">🏆</div>
                    <p className="text-gray-200 text-sm font-semibold">
                      Hackathon Winner
                    </p>
                  </div>
                </article>
                <article className="group relative bg-gradient-to-br from-purple-500/20 to-purple-600/10 rounded-2xl p-8 min-h-[140px] text-center border border-purple-500/40 hover:border-purple-400/80 hover:shadow-lg hover:shadow-purple-500/30 transition-all duration-300 cursor-default overflow-hidden">
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" aria-hidden="true">
                ...
                <article className="group relative bg-gradient-to-br from-green-500/20 to-green-600/10 rounded-2xl p-8 min-h-[140px] text-center border border-green-500/40 hover:border-green-400/80 hover:shadow-lg hover:shadow-green-500/30 transition-all duration-300 cursor-default overflow-hidden">
                  <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" aria-hidden="true">
      ...
      {/* Footer */}
      <footer className="bg-gray-950 py-12 border-t border-gray-800" role="contentinfo">
        <div className="container mx-auto px-4 flex flex-col items-center gap-8">
          <nav className="grid grid-cols-2 md:grid-cols-5 gap-6 text-sm font-medium text-gray-400">
            <a href="mailto:mraval@sfsu.edu" className="flex flex-col items-center gap-3 hover:text-blue-400 transition-colors">
              <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/></svg> Email
            </a>
            ...
            <a href="https://scholar.google.com/citations?user=3m_RhuAAAAAJ&hl=en" target="_blank" className="flex flex-col items-center gap-3 hover:text-blue-400 transition-colors">
              <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3l9 4-9 4-9-4 9-4zm0 16l-9-4v-3l9 4 9-4v3l-9 4zM12 15l-9-4 9-4 9 4-9 4z"/></svg> Scholar
            </a>
          </nav>
