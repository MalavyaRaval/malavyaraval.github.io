  ...
  const projects = [
    {
      id: 1,
      title: 'LSP',
      description: 'Language Server Protocol implementation featuring intelligent code analysis and real-time diagnostics for enhanced developer experience.',
    ...
    },
    {
      id: 2,
      title: 'SafeWalk',
      description: 'Real-time safety platform that won a hackathon. Leverages geolocation and real-time notifications to keep users safe.',
    ...
    },
    {
      id: 3,
      title: 'CareerBoost',
      description: 'Full-stack application designed to enhance career development with personalized recommendations and progress tracking.',
    ...
    },
    {
      ...
      description: 'GPU-accelerated image denoising using CUDA. Implements advanced signal processing algorithms for optimal performance.',
    ...
    },
    {
      id: 5,
      title: 'Web Scrapping',
      description: 'Efficient web scraping tool built with Python for data collection and analysis from various web sources.',
    ...
    },
    {
      ...
      description: 'Comprehensive Jupyter Notebook collection implementing classical machine learning algorithms and experiments.',
