export default function Skills() {
  const skillCategories = [
    {
      category: 'Languages',
      skills: ['TypeScript', 'Python', 'Java', 'C++', 'JavaScript', 'SQL', 'C', 'Swift'],
    },
    {
      category: 'Frontend',
      skills: ['React', 'HTML/CSS', 'Tailwind CSS', 'Responsive Design', 'Redux'],
    },
    {
      category: 'Backend & Databases',
      skills: ['Node.js', 'Express.js', 'REST APIs', 'PostgreSQL', 'MongoDB', 'GraphQL', 'Docker'],
    },
    {
      category: 'AI/ML & Data',
      skills: ['Machine Learning', 'Data Analysis', 'Jupyter', 'Classical ML', 'Image Processing'],
    },
    {
      category: 'DevOps & Cloud',
      skills: ['AWS', 'Google Cloud', 'Azure', 'Kubernetes', 'Terraform', 'GitHub', 'CI/CD'],
    },
    {
      category: 'Tools & Platforms',
      skills: ['Git', 'Vim', 'Linux', 'Figma', 'Slack', 'Trello', 'GitLab', 'Vercel', 'Photoshop'],
    },
  ]
